...
public class MyMaze {
  ...
  public void updateGrid() {
      char backChar = ' ', wallChar = '%', spaceChar = ' ', pathChar = '*';
      // fill background
              ...
              if (current.inPath) {
                  ...
                  if (current.isCellRightNeighbor())
                      if (getCell(x + 1, y).inPath) {
                          ...
                          grid[gridX + 2][gridY] = spaceChar;
                          grid[gridX + 1][gridY] = spaceChar;
                          grid[gridX + 3][gridY] = spaceChar;
                      }
              } else {
                  grid[gridX][gridY] = spaceChar;
                  if (current.isCellBelowNeighbor()) {
                      grid[gridX][gridY + 1] = spaceChar;
                      grid[gridX + 1][gridY + 1] = backChar;
                      grid[gridX - 1][gridY + 1] = backChar;
